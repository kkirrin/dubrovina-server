...
export interface ApiAdvantagesOurCompanyAdvantagesOurCompany
  extends Struct.SingleTypeSchema {
  collectionName: 'advantages_our_companies';
  info: {
    displayName: 'Advantages our company';
    pluralName: 'advantages-our-companies';
    singularName: 'advantages-our-company';
  };
  options: {
  ...
  attributes: {
    Addvantages: Schema.Attribute.JSON &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::advantages-our-company.advantages-our-company'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiStraniczaOKlinikeStraniczaOKlinike
  extends Struct.SingleTypeSchema {
  collectionName: 'stranicza_o_klinikes';
  info: {
    displayName: '\u0421\u0442\u0440\u0430\u043D\u0438\u0446\u0430 \u041E \u043A\u043B\u0438\u043D\u0438\u043A\u0435';
    pluralName: 'stranicza-o-klinikes';
    singularName: 'stranicza-o-klinike';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::stranicza-o-klinike.stranicza-o-klinike'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
